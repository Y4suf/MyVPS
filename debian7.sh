...
wget -O /etc/nginx/nginx.conf "https://github.com/Y4suf/MyVPS/blob/master/nginx.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Y4suf/MyVPS/master/badvpn-udpgw"
sed -i '$ i\screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300' /etc/rc.local
chmod +x /usr/bin/badvpn-udpgw
screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300

# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Y4suf/MyVPS/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Y4suf/MyVPS/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/Y4suf/MyVPS/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/Y4suf/MyVPS/master/squid.conf"
...
wget https://raw.githubusercontent.com/Y4suf/MyVPS/master/ddos-deflate-master.zip
